...
import nf0 from "./nf0.js";
import { info   } from "./info.js";
import { logger } from "./logger.js";
import Cs from "../fastpng/fast-png-bundle.js";
const println = logger.println;
const printst = logger.println;
const cout = logger.cout;
        ...
        for (var memberID = 0; memberID < numberOfMembers; memberID += 1) {
            ...
            if (SectionNumbers.length > 1) {
                ...
                switch (this.TypeOfProjection) {
                    ...
                    case 1100: gridDefScanningMode = 51; println("HovmÃ¶ller diagram grid, with points equally spaced on the horizontal"); break;
            ...
            if (SectionNumbers.length > 1) {
                ...
                if (this.DataRepresentationTemplateNumber === 40 ) { // Grid point data â€“ JPEG 2000 Code Stream Format
                    ...
                    printst("PNG/Type of Compression:\t");
                }
            ...
            if ( this.DataRepresentationTemplateNumber === 40) {
                ...
                BitmapBeginPointer = nPointer + 6;
                let dataBlock = this.getGrib2Section(7);
                let pngData  = this.fileBytes.slice(BitmapBeginPointer, nPointer)
                lThis.data = options.pngDecoder(pngData);
            }
